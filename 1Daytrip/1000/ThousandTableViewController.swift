//
//  ThousandTableViewController.swift
//  1Daytrip
//
//  Created by Kanyaneee Promma on 20/2/2561 BE.
//  Copyright © 2561 Kanyaneee Promma. All rights reserved.
//

import UIKit

class ThousandTableViewController: UITableViewController {

    let URL_ME = "https://kanyanee.000webhostapp.com/comsci_1DayTrip/select1000.php"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "MyCell", for: indexPath) as! ThousandTableViewCell
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "thousandSegue"
        {
