...
//  1Daytrip
//
//  Created by Kanyaneee Promma on 21/2/2561 BE.
...
class MoreTableViewController: UITableViewController {
    let URL_ME = "https://kanyanee.000webhostapp.com/comsci_1DayTrip/selectMore.php"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "MyCell", for: indexPath) as! MoreTableViewCell
