...
class NorthTableViewController: UITableViewController {
    let URL_ME = "http://iot.spu.ac.th/~comsci/comsci_1DayTrip/selectTest.php"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "MyCell", for: indexPath) as! NorthTableViewCell
